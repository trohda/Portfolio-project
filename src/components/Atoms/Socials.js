  ...
  return (
    <div className="socials">
      <div>
        ...
        <p className="socialPLinkedIn">LinkedIn</p>
      </div>

      <div>
        <a href="https://github.com/trohda" target="blank" rel="noreferrer">
          <svg
            className="gitHubInSocials"
            viewBox="0 0 24 24"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
        ...
        <p className="socialPGitHub">GitHub</p>
      </div>
      <div>
        <a
	...
	l25.243,23.002H12.309L37.436,51.132z M64.778,49.232L90.169,26.04v46.33L64.778,49.232z"
        ...
        <p className="socialPMail">E-Mail</p>
      </div>
      <div>
        <a href="https://wa.me/48501096652" rel="noreferrer" target="blank">
          <svg
            className="whatsappInSocials"
            version="1.1"
            id="Capa_1"
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
        ...
        <p className="socialPWhatssApp">WhatssApp</p>
      </div>
      <div>
        <a href="tel:501-096-652" rel="noreferrer">
          <svg
            className="mobileInSocials"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 64 64"
          >
        ...
        <p className="socialPMobile">Mobile</p>
      </div>
    </div>
  );
};
